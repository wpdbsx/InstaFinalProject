...
public class bunsikAdapter extends RecyclerView.Adapter<bunsikAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"bunsik_red","bunsik_dd","bunsik_yd","bunsik_chung","bunsik_kok"};
    View view;
    Holder holder;
    ...
    public bunsikAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("bunsik/"+food[i]).get().addOnSuccessListener(
