...
public class ChinaFoodAdapter extends RecyclerView.Adapter<ChinaFoodAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"bidanbi","bugkun","hungkon","moklan","ssanghe"};
    View view;
    Holder holder;
    ...
    public ChinaFoodAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("china/"+food[i]).get().addOnSuccessListener(
