...
public class chickenFoodAdapter extends RecyclerView.Adapter<chickenFoodAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"ck_chulin","ck_chungdo","ck_chungman","ck_inseng","ck_musae"};
    View view;
    Holder holder;
    ...
    public chickenFoodAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("chicken_f/"+food[i]).get().addOnSuccessListener(
