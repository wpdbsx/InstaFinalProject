...
public class KoreaFoodAdapter extends RecyclerView.Adapter<KoreaFoodAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"korea_dubu","korea_haksu","korea_jungsung","Korea_nature","korea_oong"};
    View view;
    Holder holder;
    ...
    public KoreaFoodAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("Korea_f/"+food[i]).get().addOnSuccessListener(
