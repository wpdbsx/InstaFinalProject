...
public class pizzafoodAdapter extends RecyclerView.Adapter<pizzafoodAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"pizza_athome","pizza_country","pizza_mall","pizza_mr","pizza_ody"};
    View view;
    Holder holder;
    ...
    public pizzafoodAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("pizza_f/"+food[i]).get().addOnSuccessListener(
