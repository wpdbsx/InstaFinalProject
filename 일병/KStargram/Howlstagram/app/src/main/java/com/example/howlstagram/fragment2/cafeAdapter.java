...
public class cafeAdapter extends RecyclerView.Adapter<cafeAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"cafe_hollys","cafe_starbucks","cafe_theliter","cafe_thumb","cafe_venti"};
    View view;
    Holder holder;
    ...
    public cafeAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("cafe_f/"+food[i]).get().addOnSuccessListener(
