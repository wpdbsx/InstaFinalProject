...
public class JapanfoodAdapter extends RecyclerView.Adapter<JapanfoodAdapter.Holder> {
    ...
    Uri uri=null;
    String test="";
    String food[]={"japan_homaican","japan_kiyaha","japan_kyoto"," japan_lyoushi"," japan_somi"};
    View view;
    Holder holder;
    ...
    public JapanfoodAdapter(Context context, List<WordItemData> list) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        firebaseFirestore.document("japan/"+food[i]).get().addOnSuccessListener(
